...
@section('content')
    <div class="container col-md-8 col-md-offset-2">
        <div class="well well bs-component">
            ...
            @foreach($errors->all() as $error)<!-- esta variable se crea sola -->
                <p class="alert alert-danger">{{$error}}</p>
            @endforeach
            @if(session('status'))<!-- se crea la variable con el width-->
                ...
                <fieldset>
                    <legend>editar el ticket</legend>
                    ...
                    <div class="from-group">
                        <label type="checkbox" name="status"{!! $ticket->status?"":"checked" !!}>
                            ¿Cerrar este ticket?
                        </label>
                    </div>
